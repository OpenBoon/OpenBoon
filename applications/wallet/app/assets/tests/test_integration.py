...
class TestUrls:
    ...
    def test_tracks(self, login, project, api_client, monkeypatch):
        ...
        assert 'uri' in content['signedUrl']
        assert 'mediaType' in content['signedUrl']
        assert len(content['tracks']) == 2
        assert content['tracks'] == [
            {'label': 'gcp-video-logo-detection',
             'kind': 'metadata',
             'src': '/api/v1/projects/6abc33f0-4acf-4196-95ff-4cbb7f640a06/assets/vZgbkqPftuRJ_-Of7mHWDNnJjUpFQs0C/webvtt/gcp-video-logo-detection.vtt/'},
            {'label': 'gcp-video-object-detection',
             'kind': 'metadata',
             'src': '/api/v1/projects/6abc33f0-4acf-4196-95ff-4cbb7f640a06/assets/vZgbkqPftuRJ_-Of7mHWDNnJjUpFQs0C/webvtt/gcp-video-object-detection.vtt/'}]
