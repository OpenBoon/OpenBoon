...
class TestApikey:
    ...
    def test_get_zmlp_list(self, zmlp_project_user, project, api_client, monkeypatch):
    ...
    @override_settings(PLATFORM='zmlp')
    def test_get_detail(self, zmlp_project_user, project, api_client, monkeypatch):
    ...
    @override_settings(PLATFORM='zmlp')
    def test_post_create(self, zmlp_project_user, project, api_client, monkeypatch):
    ...
    @override_settings(PLATFORM='zmlp')
    def test_post_create_bad_body(self, zmlp_project_user, project, api_client, monkeypatch):
        def mock_api_response(*args, **kwargs):
            return {'keyId': '9a27e6fd-3396-4d98-8641-37f6d05e3275', 'projectId': '00000000-0000-0000-0000-000000000000', 'sharedKey': '8Uf36TXK6cvbMEJp2ktwreRuynaVof0rruKDQRLj5dwh8fvWZcJgk2fUIM7XrSjoTQBhcDilBJ84kvVmry_NIQ', 'name': 'job-runner', 'permissions': ['JobRunner', 'AssetsWrite', 'AssetsRead', 'StorageCreate']}  # noqa
