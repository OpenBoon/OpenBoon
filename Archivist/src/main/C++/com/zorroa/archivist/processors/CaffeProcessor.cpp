...
Java_com_zorroa_archivist_processors_CaffeProcessor_createCaffeClassifier(JNIEnv *env, jobject jself, jstring deployObj, jstring modelObj, jstring meanObj, jstring wordObj) {
    static bool initialized = false;
    if (!initialized) {
        initialized = true;
        google::InitGoogleLogging("archivist");
    }
...
JNIEXPORT jstring JNICALL Java_com_zorroa_archivist_processors_CaffeProcessor_classify(JNIEnv *env, jobject jself, jlong jclassifier, jstring imageObj) {
