...
class ElementTests(TestCase):
    ...
    def test_create_rect_element_with_file(self):
        element = Element('object', 'cat', stored_file=self.stored_file)
