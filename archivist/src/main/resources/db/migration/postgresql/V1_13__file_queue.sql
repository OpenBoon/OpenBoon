...
INSERT INTO users(pk_user, pk_organization, str_username, str_password, str_email, str_firstname, str_lastname, bool_enabled, str_source, pk_permission, pk_folder, bool_reset_pass, str_reset_pass_token, time_reset_pass, json_settings) values
  ('00000000-7B0B-480E-8C36-F06F04AED2B2', '00000000-9998-8888-7777-666666666666', 'batch_user_00000000-9998-8888-7777-666666666666', '$2a$10$61erDtvsR5jl3smXZQvkVOf5ei9P.wZtyCkyLUsC.BGFyTbg6AMf2', 'batch_user_00000000-9998-8888-7777-666666666666@zorroa.com', 'Batch', 'User', TRUE, 'internal', null,  null, TRUE, NULL, 0, '{}');
