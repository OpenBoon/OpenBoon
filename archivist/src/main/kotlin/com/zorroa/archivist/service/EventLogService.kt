...
class EventLogConfiguration @Autowired constructor(meterRegistrty: MeterRegistry)  {
    init {
        MeterRegistryHolder.meterRegisty = meterRegistrty
    }
...
object MeterRegistryHolder {
    ...
    lateinit var meterRegisty : MeterRegistry
    ...
    fun increment(name: String, vararg tags: Tag) {
        meterRegisty.counter(name.toLowerCase(), getTags(*tags)).increment()
    }
     ...
     */
    fun counter(name: String): Counter = meterRegisty.counter(name)
}
