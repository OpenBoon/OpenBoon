...
public class UserServiceTests extends AbstractTest {
    ...
    public void createUserWithPresets() {
        UserPreset presets = userService.createUserPreset(new UserPresetSpec()
                .setName("defaults")
                .setPermissionIds(Lists.newArrayList(permissionService.getPermission(Groups.MANAGER).getId()))
    ...
    public void updatePermissions() {
        ...
        Permission dev = permissionService.getPermission(Groups.DEV);
        assertTrue(userService.hasPermission(user, permissionService.getPermission(Groups.MANAGER)));
    ...
    public void testImmutablePermissions() {
        ...
        builder.setPermissionIds(new Integer[]{
                permissionService.getPermission(Groups.ADMIN).getId()});

        Permission sup = permissionService.getPermission(Groups.ADMIN);
