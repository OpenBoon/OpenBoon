...
class BoonSdkJobAppTests(unittest.TestCase):
...
mock_task_error_data = {
    ...
    'path': '/Users/chambers/src/boonai/test-data/images/cow.jpg',
    'phase': 'execute',
    'processor': 'boonai_core.core.FileImportProcessor',
    'stackTrace': [{'className': 'process',
                    'file': '/usr/local/lib/python3.7/dist-packages/booncd/process.py',
                    'lineNumber': 293,
