package boonai.authserver.domain

import com.auth0.jwt.JWT
import com.auth0.jwt.algorithms.Algorithm
import com.fasterxml.jackson.annotation.JsonIgnore
import boonai.authserver.repository.AbstractJpaFilter
import boonai.authserver.repository.EncryptedConverter
...
import boonai.common.service.jpa.StringSetConverter
...
class ValidationKey(
    ...
    fun getJwtToken(timeout: Int = 60, projId: UUID? = null): String {
        ...
        val spec = JWT.create().withIssuer("boonai")
