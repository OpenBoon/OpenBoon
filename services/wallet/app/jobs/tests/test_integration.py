...
class TestJobViewSet:
    ...
    def test_put_pause(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        updated_info_return = {
            'name': 'Test',
            'priority': 100,
        ...
        def mock_api_response(*args, **kawargs):
            ...
            response = Response()
            response._content = b'{"id": "b8ec649d-67bc-1ab4-a0ae-0242ac120007", "organizationId": "00000000-9998-8888-7777-666666666666", "name": "import-test-data-all.json", "type": "Import", "state": "Finished", "assetCounts": {"assetCreatedCount": 246, "assetReplacedCount": 54, "assetWarningCount": 0, "assetErrorCount": 1}, "taskCounts": {"tasksTotal": 8, "tasksWaiting": 0, "tasksRunning": 0, "tasksSuccess": 8, "tasksFailure": 0, "tasksSkipped": 0, "tasksQueued": 0}, "createdUser": {"id": "00000000-7b0b-480e-8c36-f06f04aed2f1", "username": "admin", "email": "admin@zorroa.com", "permissionId": "00000000-fc08-4e4a-aa7a-a183f42c9fa0", "homeFolderId": "00000000-2395-4e71-9e4c-dacceef6ad53", "organizationId": "00000000-9998-8888-7777-666666666666"}, "timeStarted": 1574891251035, "timeUpdated": 1574891738399, "timeCreated": 1574891249308, "priority": 100, "paused": true, "timePauseExpired": -1, "maxRunningTasks": 0, "jobId": "b8ec649d-67bc-1ab4-a0ae-0242ac120007"}'
            return response
        ...
        assert response.status_code == 200
        content = response.json()
        assert content['paused'] == True

    def test_put_resume(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        updated_info_return = {
            'name': 'Test',
            'priority': 100,
        ...
        def mock_api_response(*args, **kawargs):
            ...
            assert body == updated_info_return
            response = Response()
            response._content = b'{"id": "b8ec649d-67bc-1ab4-a0ae-0242ac120007", "organizationId": "00000000-9998-8888-7777-666666666666", "name": "import-test-data-all.json", "type": "Import", "state": "Finished", "assetCounts": {"assetCreatedCount": 246, "assetReplacedCount": 54, "assetWarningCount": 0, "assetErrorCount": 1}, "taskCounts": {"tasksTotal": 8, "tasksWaiting": 0, "tasksRunning": 0, "tasksSuccess": 8, "tasksFailure": 0, "tasksSkipped": 0, "tasksQueued": 0}, "createdUser": {"id": "00000000-7b0b-480e-8c36-f06f04aed2f1", "username": "admin", "email": "admin@zorroa.com", "permissionId": "00000000-fc08-4e4a-aa7a-a183f42c9fa0", "homeFolderId": "00000000-2395-4e71-9e4c-dacceef6ad53", "organizationId": "00000000-9998-8888-7777-666666666666"}, "timeStarted": 1574891251035, "timeUpdated": 1574891738399, "timeCreated": 1574891249308, "priority": 100, "paused": false, "timePauseExpired": -1, "maxRunningTasks": 0, "jobId": "b8ec649d-67bc-1ab4-a0ae-0242ac120007"}'
            return response
        monkeypatch.setattr(PixmlClient, 'put', mock_api_response)
        ...
        assert response.status_code == 200
        content = response.json()
        assert content['paused'] == False

    def test_put_cancel(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'

        def mock_api_response(*args, **kwargs):
            response = Response()
            response._content = b'{"type":"Job","id":"b8ec649d-67bc-1ab4-a0ae-0242ac120007","op":"cancel","success":false}'
            return response
    ...
    def test_put_restart(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'

        def mock_api_response(*args, **kwargs):
            response = Response()
            response._content = b'{"type":"Job","id":"b8ec649d-67bc-1ab4-a0ae-0242ac120007","op":"restart","success":true}'
            return response
    ...
    def test_put_priority_no_body(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        api_client.force_authenticate(user)
        api_client.force_login(user)
    ...
    def test_put_priority_bad_body(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        api_client.force_authenticate(user)
        api_client.force_login(user)
        response = api_client.put(reverse('job-priority',
    ...
    def test_put_priority(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        updated_info_return = {
            'name': 'Test',
            'priority': 12,
        ...
        def mock_api_response(*args, **kwargs):
            ...
            assert body['priority'] == 12
            response = Response()
            response._content = b'{"id":"b8ec649d-67bc-1ab4-a0ae-0242ac120007","organizationId":"00000000-9998-8888-7777-666666666666","name":"import-test-data-all.json","type":"Import","state":"Active","assetCounts":{"assetCreatedCount":246,"assetReplacedCount":54,"assetWarningCount":0,"assetErrorCount":1},"taskCounts":{"tasksTotal":8,"tasksWaiting":0,"tasksRunning":0,"tasksSuccess":8,"tasksFailure":0,"tasksSkipped":0,"tasksQueued":0},"createdUser":{"id":"00000000-7b0b-480e-8c36-f06f04aed2f1","username":"admin","email":"admin@zorroa.com","permissionId":"00000000-fc08-4e4a-aa7a-a183f42c9fa0","homeFolderId":"00000000-2395-4e71-9e4c-dacceef6ad53","organizationId":"00000000-9998-8888-7777-666666666666"},"timeStarted":1574891251035,"timeUpdated":1575398506659,"timeCreated":1574891249308,"priority":12,"paused":true,"timePauseExpired":-1,"maxRunningTasks":0,"jobId":"b8ec649d-67bc-1ab4-a0ae-0242ac120007"}'
            return response
    ...
    def test_put_max_running_tasks_no_body(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        api_client.force_authenticate(user)
        api_client.force_login(user)
    ...
    def test_put_max_running_tasks_bad_body(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        api_client.force_authenticate(user)
        api_client.force_login(user)
        response = api_client.put(reverse('job-max-running-tasks',
        ...
        assert response.status_code ==  400
        assert response.json()['msg'] == 'Invalid `max_running_tasks` value provided. Expected an integer.'

    def test_put_max_running_tasks(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        updated_info_return = {
            'name': 'Test',
            'priority': 0,
        ...
        def mock_api_response(*args, **kwargs):
            ...
            assert body['maxRunningTasks'] == 10
            response = Response()
            response._content = b'{"id":"b8ec649d-67bc-1ab4-a0ae-0242ac120007","organizationId":"00000000-9998-8888-7777-666666666666","name":"import-test-data-all.json","type":"Import","state":"Active","assetCounts":{"assetCreatedCount":246,"assetReplacedCount":54,"assetWarningCount":0,"assetErrorCount":1},"taskCounts":{"tasksTotal":8,"tasksWaiting":0,"tasksRunning":0,"tasksSuccess":8,"tasksFailure":0,"tasksSkipped":0,"tasksQueued":0},"createdUser":{"id":"00000000-7b0b-480e-8c36-f06f04aed2f1","username":"admin","email":"admin@zorroa.com","permissionId":"00000000-fc08-4e4a-aa7a-a183f42c9fa0","homeFolderId":"00000000-2395-4e71-9e4c-dacceef6ad53","organizationId":"00000000-9998-8888-7777-666666666666"},"timeStarted":1574891251035,"timeUpdated":1575405463175,"timeCreated":1574891249308,"priority":12,"paused":false,"timePauseExpired":-1,"maxRunningTasks":10,"jobId":"b8ec649d-67bc-1ab4-a0ae-0242ac120007"}'
            return response
    ...
    def test_put_retry_all_failures(self, user, project, pixml_project_membership, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'

        def mock_api_response(*args, **kwargs):
            response = Response()
            response._content = b'{"type":"Job","id":"b8ec649d-67bc-1ab4-a0ae-0242ac120007","op":"retryAllFailures","success":false}'
            return response
    ...
    def test_get_updated_info(self, api_client, monkeypatch):
        pk = 'b8ec649d-67bc-1ab4-a0ae-0242ac120007'
        viewset = JobsViewSet()
        ...
        new_job_spec = viewset._get_updated_info(api_client, pk, new_values)
