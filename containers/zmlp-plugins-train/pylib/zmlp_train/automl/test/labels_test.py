...
from zmlp_train.automl.labels import AutomlLabelDetectionSession, AutomlVideoLabelDetectionSession
...
class AutomlVideoLabelDetectionSessionTests(PluginUnitTestCase):
    def setUp(self):
        self.model = Model({
            'id': '00000000-0000-0000-0000-000000000000',
            'name': 'unittest-test'
    ...
    def test_create_instance(self, get_proj_patch, client_patch):
        ...
        dsimp = AutomlVideoLabelDetectionSession(self.model)
        self.assertEquals('projects/zvi-dev/locations/us-central1', dsimp.project_location)
    ...
    def test_create_automl_dataset(self, get_proj_patch, client_patch):
        ...
        session = AutomlVideoLabelDetectionSession(self.model)
        dataset = session._create_automl_dataset()
        self.assertEquals("test", dataset.name)
