...
class ClarifaiBboxDetectionPublicModelsProcessorIntegrationTests(PluginUnitTestCase):
    ...
    def test_face_detection_process(self):
        self.run_process(
            ...
            detector=ClarifaiVideoFaceDetectionProcessor(),
            attr='clarifai-video-face-detection-model',
    ...
    def test_logo_process(self):
        self.run_process(
            ...
            detector=ClarifaiVideoLogoDetectionProcessor(),
            attr='clarifai-video-logo-model',
