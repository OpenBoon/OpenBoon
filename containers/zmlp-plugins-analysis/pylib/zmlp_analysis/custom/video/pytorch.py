...
class VideoPytorchTransferLearningClassifier(AssetProcessor):
    """Classifier for retrained saved model on video """

    file_types = FileTypes.videos

    def __init__(self, extract_type=None):
        super(VideoPytorchTransferLearningClassifier, self).__init__()
    ...
    def init(self):
        ...
        self.tf_client = PytorchTransferLearningClassifier()
        self.tf_client.init()
