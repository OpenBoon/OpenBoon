...
from zmlp_analysis.custom.video import VideoTensorflowImageClassifier
...
class VideoTensorflowTransferLearningClassifierTests(PluginUnitTestCase):
    ...
    @patch("zmlp_analysis.custom.video.tf2.video.save_timeline", return_value={})
    @patch('zmlp_analysis.custom.video.tf2.proxy.get_video_proxy')
    def test_predict(self, proxy_path_patch, _, file_patch, model_patch):
        ...
        processor = self.init_processor(
            VideoTensorflowImageClassifier(), args
        )
