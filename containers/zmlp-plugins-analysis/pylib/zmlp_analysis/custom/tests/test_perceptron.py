...
from zmlp_analysis.custom.perceptron import LabelDetectionPerceptionClassifier
...
class LabelDetectionClassifiersUnitTests(PluginUnitTestCase):
    ...
    @patch("zmlp_analysis.custom.perceptron.LabelDetectionPerceptionClassifier.get_labels")
    def test_PerceptronClassifier(
        self, label_patch, file_patch, model_patch
    ):
        file_patch.return_value = zorroa_test_path("training/pets")
