...
class CloudVisionDetectDocumentTextTests(PluginUnitTestCase):
    ...
    @patch.object(file_storage.assets, 'get_native_uri')
    @patch(patch_path, side_effect=MockImageAnnotatorClient)
    def test_detect_document_text(self, _, native_patch, localize_patch, proxy_patch):
    ...
    @patch.object(file_storage.assets, 'get_native_uri')
    @patch(patch_path, side_effect=MockImageAnnotatorClient)
    def test_detect_document_text_with_ocr_proxy(self, _, native_patch, localize_patch,
                                                 proxy_patch):
