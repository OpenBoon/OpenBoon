...
from zmlp_analysis.aws.nsfw import RekognitionUnsafeDetection

MAX_LENGTH_SEC = 120


class RekognitionVideoUnsafeDetection(AssetProcessor):
    ...
    def init(self):
        self.image_client = RekognitionUnsafeDetection()
    ...
    def set_analysis(self, extractor, clip_tracker, proc):
        ...
        for time_ms, path in extractor:
            predictions = proc.predict(path, analysis.min_score)
