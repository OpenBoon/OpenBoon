...
from zmlp_analysis.clarifai.labels import (
    ...
    ClarifaiRegionDetectionProcessor,
    ClarifaiBoundingBoxDetectionProcessor,
...
class ClarifaiBoundingBoxDetectionPublicModelsProcessorIntegrationTests(PluginUnitTestCase):
    ...
    def test_face_detection_process(self):
        self.run_process(
            ...
            attr='analysis.clarifai-region-face-detection-model',
            assertions={'labels': ['Necklace'], 'count': 6}
        )
    ...
    def test_logo_process(self):
        self.run_process(
            ...
            attr='analysis.clarifai-region-logo-model',
            assertions={'labels': ['bride'], 'count': 20}
        )
