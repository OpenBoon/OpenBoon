...
from boonflow import AssetProcessor, FileTypes, file_storage
from boonflow import proxy
from boonflow.analysis import LabelDetectionAnalysis, ContentDetectionAnalysis
from boonflow.clips import ClipTracker, TimelineBuilder
    ...
    def set_analysis(self, extractor, clip_tracker, proc):
        ...
        for time_ms, path in extractor:
            ...
            for ls in predictions:
                analysis.add_label_and_score(ls[0], float(ls[1]))
