...
import boonai_analysis.azure.vision as vision
...
patch_path = 'boonai_analysis.azure.util.ComputerVisionClient'
cred_path = 'boonai_analysis.azure.util.CognitiveServicesCredentials'

DOGBIKE = test_path('images/detect/dogbike.jpg')
STREETSIGN = test_path("images/set09/streetsign.jpg")
RYAN_GOSLING = test_path('images/set08/meme.jpg')
EIFFEL_TOWER = test_path('images/set11/eiffel_tower.jpg')
LOGOS = test_path('images/set11/logos.jpg')
NSFW = test_path('images/set10/nsfw1.jpg')
...
class AzureVisionProcessorTests(PluginUnitTestCase):
    ...
    @patch("boonai_analysis.azure.vision.get_proxy_level_path")
    ...
    @patch("boonai_analysis.azure.vision.get_proxy_level_path")
    @patch('boonai_analysis.azure.vision.get_zvi_azure_cv_client')
