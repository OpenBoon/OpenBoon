...
from boonflow import Argument, AssetProcessor, FileTypes
from boonflow import file_storage
from boonflow.analysis import LabelDetectionAnalysis, ContentDetectionAnalysis
from boonflow.proxy import get_proxy_level_path, get_proxy_level, calculate_normalized_bbox
...
class AbstractAzureVisionProcessor(AssetProcessor):
    ...
    def _predict(self, path):
        """Prediction impl function to be implemented by subclasses.
