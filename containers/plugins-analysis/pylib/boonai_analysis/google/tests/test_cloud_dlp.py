...
from boonai_analysis.google.cloud_dlp import CloudDLPDetectEntities
from boonai_analysis.google.cloud_vision import file_storage
from boonflow import Frame
from boonflow.testing import PluginUnitTestCase, TestAsset, test_path, get_mock_stored_file
...
class CloudDLPDetectEntitiesTests(PluginUnitTestCase):
    ...
    @patch('boonai_analysis.google.cloud_dlp.initialize_gcp_client',
           side_effect=MockDlpServiceClient)
    @patch('boonai_analysis.google.cloud_dlp.get_gcp_project_id')
    @patch('boonai_analysis.google.cloud_dlp.get_proxy_level_path')
