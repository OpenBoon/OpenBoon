...
from boonai_analysis.boonai.color import TiledColorSimilarity
from boonflow import Frame
from boonflow.testing import PluginUnitTestCase, TestAsset, test_path


class ColorSimilarityTests(PluginUnitTestCase):
    ...
    def test_process(self, proxy_patch):
        ...
        processor = self.init_processor(TiledColorSimilarity(), {})
