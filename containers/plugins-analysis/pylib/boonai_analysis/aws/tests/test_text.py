...
from boonai_analysis.aws import RekognitionTextDetection
...
class RekognitionLabelDetectionProcessorTests(PluginUnitTestCase):
    ...
    @patch("boonai_analysis.aws.text.get_proxy_level_path")
    ...
    def test_predict(self, client_patch, proxy_patch):
        ...
        flower_paths = test_path("images/set08/meme.jpg")
