...
class ClarifaiLabelDetectionPublicModelsProcessorIntegrationTests(PluginUnitTestCase):
    ...
    def test_travel_process(self):
        self.run_process(
            image_path=test_path('images/set06/gif_tahoe.gif'),
    ...
    def test_wedding_process(self):
        self.run_process(
            image_path=test_path('images/set11/wedding1.jpg'),
    ...
    def test_nsfw_process(self):
        self.run_process(
            image_path=test_path('images/set10/nsfw1.jpg'),
    ...
    def test_textures_and_patterns_process(self):
        self.run_process(
            image_path=test_path('images/set09/letter.png'),
