...
from boonai_analysis.clarifai.video import regions
...
class ClarifaiColorDetectionPublicModelsProcessorIntegrationTests(PluginUnitTestCase):
    ...
    @patch("boonai_analysis.clarifai.video.regions.video.save_timeline", return_value={})
    @patch('boonai_analysis.clarifai.video.regions.proxy.get_video_proxy')
