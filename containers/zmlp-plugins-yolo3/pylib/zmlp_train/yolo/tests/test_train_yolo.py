...
from zmlp_train.yolo import YOLOTransferLearningTrainer
...
assets = [
    TestAsset(
        "flowers/daisy/5547758_eea9edfd54_n.jpg", id="5547758_eea9edfd54_n"
    ),
    TestAsset(
        "flowers/daisy/5673551_01d1ea993e_n.jpg", id="5673551_01d1ea993e_n"
    ),
    TestAsset(
        "flowers/daisy/5673551_01d1ea993e_n.jpg", id="5673551_01d1ea993e_n"
    ),
    TestAsset(
        "flowers/daisy/5794835_d15905c7c8_n.jpg", id="5794835_d15905c7c8_n"
    ),
    TestAsset(
        "flowers/daisy/5794839_200acd910c_n.jpg", id="5794839_200acd910c_n"
    ),
    TestAsset(
        "flowers/daisy/11642632_1e7627a2cc.jpg", id="11642632_1e7627a2cc"
    ),
    TestAsset(
        "flowers/roses/102501987_3cdb8e5394_n.jpg", id="102501987_3cdb8e5394_n"
    ),
    TestAsset(
        "flowers/roses/110472418_87b6a3aa98_m.jpg", id="110472418_87b6a3aa98_m"
    ),
    TestAsset(
        "flowers/roses/12240303_80d87f77a3_n.jpg", id="12240303_80d87f77a3_n"
    ),
    TestAsset(
        "flowers/roses/22679076_bdb4c24401_m.jpg", id="22679076_bdb4c24401_m"
    ),
    TestAsset(
        "flowers/roses/24781114_bc83aa811e_n.jpg", id="24781114_bc83aa811e_n"
    ),
    TestAsset(
        "flowers/roses/99383371_37a5ac12a3_n.jpg", id="99383371_37a5ac12a3_n"
    ),
]
...
def download_dataset(ds_id, dst_dir, ratio):
    ...
    for asset in assets[0:3]:
        shutil.copy(
            os.path.dirname(__file__) + "/" + asset.get_attr("source.path"),
...
class YOLOTransferLearningTrainerTests(PluginUnitTestCase):
    ds_id = "ds-id-12345"
    ...
    def prep_assets(self):
        for asset in assets:
            ...
            asset.set_attr(
                "labels",
                [{"dataSetId": self.ds_id, "label": asset.uri.split("/")[1]}],
            )
    ...
    def test_process(self, upload_patch, labels_patch, dataset_patch):
        ...
        args = {
            ...
            "min_examples": 6,
            "epochs": 5,
            "weights": "{}/data/yolov3.weights".format(path_yolo),
        }

        processor = self.init_processor(YOLOTransferLearningTrainer(), args)
