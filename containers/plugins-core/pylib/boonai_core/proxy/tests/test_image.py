...
from boonai_core.proxy.image import ImageProxyProcessor
...
TOUCAN_PATH = test_data("images/set01/toucan.jpg", uri=False)
TOUCAN = test_data("images/set01/toucan.jpg")
BEER = test_data("images/set02/beer_kettle_01.jpg")
VIDEO = test_data("video/dc.webm")
TOUCAN = test_data("images/set01/toucan.jpg")
TIFF = test_data("office/multipage_tiff_small.tif")
EXR = test_data("images/set06/grid-overscan.exr")
