...
from boonai_core.util import media
...
IMAGE_EXR = test_data('images/set06/SquaresSwirls.exr', False)
IMAGE_PSD = test_data('images/set06/psd_123.psd', False)
IMAGE_JPG = test_data('images/set02/beer_kettle_01.jpg', False)
VIDEO_WEBM = test_data('video/dc.webm', False)
VIDEO_MP4 = test_data('video/FatManOnABike1914.mp4', False)
VIDEO_MXF = test_data('mxf/freeMXF-mxf1.mxf', False)
VIDEO_MOV = test_data('video/1324_CAPS_23.0_030.00_15_MISC.mov', False)
...
@patch('boonai_core.util.media.check_output')
