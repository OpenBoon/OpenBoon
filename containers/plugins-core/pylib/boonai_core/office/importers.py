...
from boonflow import AssetProcessor, Argument, \
    ExpandFrame, FatalProcessorException, FileTypes, StopWatch
...
class OfficeImporter(AssetProcessor):
    ...
    def get_metadata(self, asset, page):
        ...
        Raises:
            FatalProcessorException: If the file cannot be found
    ...
    def render_pages(self, asset, page, all_pages):
        ...
        Raises:
            FatalProcessorException if no files can be rendered or found.
