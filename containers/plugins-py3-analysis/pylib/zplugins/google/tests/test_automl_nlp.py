...
class AutoMLNLPUnitTests(PluginUnitTestCase):
    ...
    def do_not_test_multipage(self):
        ...
        frame_0 = zsdk.Frame(zsdk.Document())
        frame_0.asset.id = 'f0'
        frame_0.asset.set_attr('media.pages', 5)

        frame_1 = zsdk.Frame(zsdk.Document())
        frame_1.asset.id = 'f1'
        ...
        frame_2 = zsdk.Frame(zsdk.Document())
        frame_2.asset.id = 'f2'
        ...
        frame_3 = zsdk.Frame(zsdk.Document())
        frame_3.asset.id = 'f3'
        ...
        frame_4 = zsdk.Frame(zsdk.Document())
        frame_4.asset.id = 'f4'
        ...
        frame_5 = zsdk.Frame(zsdk.Document())
        frame_5.asset.id = 'f5'
