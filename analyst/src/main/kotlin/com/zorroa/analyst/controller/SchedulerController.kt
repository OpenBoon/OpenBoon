...
import com.zorroa.analyst.service.MasterScheduler
...
class SchedulerController @Autowired constructor(
    ...
    fun resume() : ResponseEntity<UpdateStatus>  {
        return ResponseEntity.ok(UpdateStatus("resume", masterScheduler.resume()))
    }
}
