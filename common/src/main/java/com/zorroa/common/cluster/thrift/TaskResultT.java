            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errors = new java.util.ArrayList<TaskErrorT>(_list10.size);
                TaskErrorT _elem11;
                for (int _i12 = 0; _i12 < _list10.size; ++_i12)
                {
                  _elem11 = new TaskErrorT();
                  _elem11.read(iprot);
                  struct.errors.add(_elem11);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TaskResultT struct) throws org.apache.thrift.TException {
      ...
      if (struct.errors != null) {
        oprot.writeFieldBegin(ERRORS_FIELD_DESC);
        {
          ...
          for (TaskErrorT _iter13 : struct.errors)
          {
            _iter13.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetErrors()) {
        {
          ...
          for (TaskErrorT _iter14 : struct.errors)
          {
            _iter14.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.errors = new java.util.ArrayList<TaskErrorT>(_list15.size);
          TaskErrorT _elem16;
          for (int _i17 = 0; _i17 < _list15.size; ++_i17)
          {
            _elem16 = new TaskErrorT();
            _elem16.read(iprot);
