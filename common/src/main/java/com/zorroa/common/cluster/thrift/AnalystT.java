            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.taskIds = new java.util.ArrayList<java.lang.Integer>(_list10.size);
                int _elem11;
                for (int _i12 = 0; _i12 < _list10.size; ++_i12)
                {
                  _elem11 = iprot.readI32();
                  struct.taskIds.add(_elem11);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AnalystT struct) throws org.apache.thrift.TException {
      ...
      if (struct.taskIds != null) {
        oprot.writeFieldBegin(TASK_IDS_FIELD_DESC);
        {
          ...
          for (int _iter13 : struct.taskIds)
          {
      ...
      if (struct.isSetTaskIds()) {
        {
          ...
          for (int _iter14 : struct.taskIds)
          {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.taskIds = new java.util.ArrayList<java.lang.Integer>(_list15.size);
          int _elem16;
          for (int _i17 = 0; _i17 < _list15.size; ++_i17)
          {
            _elem16 = iprot.readI32();
            struct.taskIds.add(_elem16);
          }
        }
        struct.setTaskIdsIsSet(true);
      }
