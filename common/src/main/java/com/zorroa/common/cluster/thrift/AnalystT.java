            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.taskIds = new java.util.ArrayList<java.lang.Integer>(_list18.size);
                int _elem19;
                for (int _i20 = 0; _i20 < _list18.size; ++_i20)
                {
                  _elem19 = iprot.readI32();
                  struct.taskIds.add(_elem19);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AnalystT struct) throws org.apache.thrift.TException {
      ...
      if (struct.taskIds != null) {
        oprot.writeFieldBegin(TASK_IDS_FIELD_DESC);
        {
          ...
          for (int _iter21 : struct.taskIds)
          {
      ...
      if (struct.isSetTaskIds()) {
        {
          ...
          for (int _iter22 : struct.taskIds)
          {
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.taskIds = new java.util.ArrayList<java.lang.Integer>(_list23.size);
          int _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = iprot.readI32();
            struct.taskIds.add(_elem24);
          }
        }
        struct.setTaskIdsIsSet(true);
      }
